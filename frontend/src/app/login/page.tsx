    ...
    <div className="relative min-h-screen flex items-center justify-center bg-slate-950 px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="border-slate-800 bg-slate-900/60 backdrop-blur-md">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-slate-100">Welcome Back</CardTitle>
            <CardDescription className="text-slate-400">
              Sign in to manage repositories and trace codebases.
            </CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="bg-slate-950/80 border-slate-800 focus:border-purple-500 text-slate-100 focus:ring-1 focus:ring-purple-500"
                  required
                />
              </div>
